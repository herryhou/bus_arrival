 ...
 *
 * RouteNode layout (#[repr(C)], 32 bytes):
 ...
 *
 * Note: v8.7 optimized RouteNode from 40 to 32 bytes:
 ...
 * - Nodes array: node_count × 32 bytes
...
const ROUTE_NODE_SIZE = 32; // v8.7: optimized from 40 to 32 bytes
const STOP_SIZE = 12;
const HEADER_SIZE_V8 = 28; // + lat_avg_deg(8) for total of 28 bytes
const MAGIC = 0x42555341; // "BUSA" in little-endian
const VERSION = 4; // v8.7 format: optimized 32-byte nodes
...
/**
 * Parse RouteNode from binary data (v8.7 format - 32 bytes)
 */
function parseRouteNode(dataView: DataView, offset: number): RouteNode {
	return {
		seg_len_mm: readI64(dataView, offset),
